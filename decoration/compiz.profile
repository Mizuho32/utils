...
s0_position_x_values = 240;200;-32768;
s0_position_y_values = 25;200;-32768;
s0_position_constrain_workarea = false;false;false;
...
s0_sticky_match = (class=Xfce4-terminal | class=Thunar ) | class=konsole
s0_fullscreen_match = 
...
s0_expo_edge = BottomLeft|BottomRight
...
[core]
s0_active_plugins = core;composite;opengl;decor;grid;blur;compiztoolbox;wall;regex;place;imgpng;move;resize;staticswitcher;winrules;animation;expo;scale;
