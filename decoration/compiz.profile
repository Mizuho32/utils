...
s0_sticky_match = (class=Xfce4-terminal | class=Thunar) | class=konsole | class=dolphin
s0_fullscreen_match = 
...
[core]
s0_active_plugins = core;composite;opengl;decor;move;compiztoolbox;blur;staticswitcher;wall;regex;grid;place;imgpng;animation;winrules;expo;resize;scale;
