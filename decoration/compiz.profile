...
[winrules]
s0_skiptaskbar_match = class=Prism | title=HideTerm
s0_skippager_match = class=Prism | title=HideTerm
s0_above_match = 
s0_below_match = title=HideTerm
s0_sticky_match = class=Xfce4-terminal | class=Thunar
s0_fullscreen_match = 
s0_maximize_match = class=Prism
s0_no_argb_match = 
s0_no_move_match = 
s0_no_resize_match = 
...
s0_position_matches = title=HideTerm;title=Computers & Contacts;
...
as_expo_edge = BottomLeft|BottomRight
...
as_left_key = <Control><Primary><Alt>h
as_left_button = <LeftEdge>Button1
as_right_key = <Control><Primary><Alt>l
as_right_button = <RightEdge>Button1
as_up_key = <Control><Primary><Alt>k
as_up_button = <TopEdge>Button1
as_down_key = <Control><Primary><Alt>j
as_down_button = <BottomEdge>Button1
...
s0_opacity_step = 5
s0_opacity_matches = (type=Menu | PopupMenu | DropdownMenu);
s0_opacity_values = 89;
...
[core]
as_active_plugins = core;ccp;move;resize;place;decoration;winrules;grid;regex;animation;staticswitcher;blur;scale;expo;wall;
